...
RUN curl https://bootstrap.pypa.io/get-pip.py | python3 - && \
    ...
    pip install --root-user-action=ignore --no-cache-dir funasr modelscope huggingface_hub pywhispercpp torch torchaudio edge-tts azure-cognitiveservices-speech py3-tts onnx onnxconverter_common
